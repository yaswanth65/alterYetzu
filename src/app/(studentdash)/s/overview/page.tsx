...
import { Calendar, Clock, Search, MoreHorizontal, CheckCircle, AlertCircle, Upload } from "lucide-react";
    ...
    Past Webinars
                ...
                {isLoading ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[1, 2, 3, 4].map((i) => (
                            <div key={i} className="h-64 bg-gray-200 rounded-[20px] animate-pulse"></div>
                        ))}
                    </div>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div key={webinar.id} className="bg-white p-5 rounded-[20px] shadow-sm border border-gray-100 flex flex-col gap-8">
                                ...
                                <div className="mt-auto space-y-2">
                                    <div className="flex items-center gap-2 text-gray-500 text-xs">
                                        <Calendar size={14} />
                                        <span>Scheduled : {webinar.scheduledDate ? new Date(webinar.scheduledDate).toLocaleDateString() : 'TBA'}</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-gray-500 text-xs">
                                        <Clock size={14} />
                            ...
                            <div key={assignment.id} className="bg-white p-5 rounded-[20px] shadow-sm border border-gray-100 flex flex-col gap-6">
                                <div className="flex gap-4">
                                    ...
                                    <div className="flex flex-col flex-1">
                                        ...
                                        <p className="text-gray-500 text-xs mb-3 line-clamp-2">{assignment.course}</p>
                                ...
                                <div className="mt-auto flex justify-between items-center text-xs">
                                    ...
                                    {assignment.isOverdue ? (
                                        <span className="text-red-500 font-medium">Overdue by {assignment.daysOverdue} days</span>
                                    ) : (
                ...
                <div>
                    {assignmentsLoading ? (
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-10 flex flex-col items-center justify-center text-center">
                            ...
                            <h3 className="text-lg font-semibold text-gray-900 mb-2">No Assignments Submitted</h3>
                            <p className="text-gray-500 text-sm mb-6 max-w-md">
                                You haven&apos;t submitted any assignments yet. Upload your first assignment to get started.
                            </p>
                            <button
                        ...
                        <div>
                            ...
                            <AssignmentsTable
                                data={assignmentsData?.assignments.filter(a =>
