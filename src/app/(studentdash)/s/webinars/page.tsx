...
export default function WebinarsPage() {
    ...
    const upcomingWebinar = {
        ...
        description: "Loren Ipsum meta description is display here Loren Ipsum meta Loren Ipsum meta description is display here Loren Ipsum meta",
    ...
    const completedWebinars = Array(4).fill({
        id: "completed",
        title: "Title of webinar",
        educatorName: "Educator name",
            ...
            <div className="mb-6">
                <div className="flex items-center gap-2 mb-4">
                    <button
                        ...
                        className={`px-6 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === "Webinar" ? "bg-white text-gray-900 shadow-sm" : "bg-transparent text-gray-500 hover:bg-gray-100"}`}
                    >
                        Webinar
                    </button>
                    <button
                        onClick={() => setActiveTab("Mentorship")}
                        className={`px-6 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === "Mentorship" ? "bg-white text-gray-900 shadow-sm" : "bg-transparent text-gray-500 hover:bg-gray-100"}`}
                    >
                        Mentorship
                    </button>
                </div>
            ...
            {activeTab === "Webinar" && (
                <>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-10">
                        {/* Hero / Upcoming Card */}
                        <div className="lg:col-span-3 bg-white  rounded-[20px] p-6 shadow-sm border border-gray-100 flex flex-col justify-between">
                            <div>
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 leading-tight">{upcomingWebinar.title}</h2>
                                            <p className="text-sm text-gray-500 mt-1">{upcomingWebinar.educatorName}</p>
                                        </div>
                                    </div>
                        ...
                        {/* Stats Card */}
                        <div className="bg-[#EBF0FF] rounded-[20px] p-6 shadow-sm flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-gray-800 mb-6">Completed Webinars</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {completedWebinars.map((webinar) => (
                                <div key={webinar.id} className="bg-white rounded-[20px] p-5 shadow-sm border border-gray-100 flex flex-col gap-4 h-full">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <div className="min-w-0">
                                            <h3 className="font-semibold text-gray-900 text-base truncate">{webinar.title}</h3>
                                            <p className="text-gray-500 text-xs truncate">{webinar.educatorName}</p>
                                        </div>
                                    </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-[20px] p-8 shadow-sm border border-gray-100">
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="flex flex-col items-center justify-center lg:border-r border-gray-100 pr-8">
                                <div className="w-24 h-24 rounded-full overflow-hidden mb-4 border-2 border-white shadow-sm">
                                    <Image
                                ...
                                <h3 className="text-xl font-bold text-gray-900 leading-tight mb-1">Mentor Name</h3>
                                ...
                                <div className="flex gap-12 w-full justify-center">
                                    <div className="text-center">
                                        ...
                                        <p className="text-[10px] text-gray-500 font-medium leading-tight">Total Webinar<br />Conducted</p>
                                    </div>
                                    <div className="text-center">
                                        <p className="text-2xl font-bold text-[#021165]">70</p>
                                        <p className="text-[10px] text-gray-500 font-medium leading-tight">Total Cohorts<br />Conducted</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-4 pl-0 lg:pl-4">
                                {[1, 2, 3, 4].map((i) => (
                                    <div key={i}>
                                        <h4 className="text-gray-500 font-medium mb-1">Education</h4>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-lg font-medium text-gray-600 mb-2">Upcoming Class</h3>
                            {[1, 2, 3].map((i) => (
                                <div key={i} className="bg-white rounded-[16px] p-5 shadow-sm border border-gray-100">
                                    <h4 className="font-semibold text-gray-900 text-base mb-0.5">Class Title</h4>
                        ...
                        <div className="space-y-6">
                            <div className="bg-white rounded-[20px] p-6 shadow-sm border border-gray-100 min-h-full flex flex-col justify-between">
                                <h3 className="text-lg font-medium text-gray-600 mb-6">Cohort Status</h3>

                                <div className="flex justify-center gap-8 mb-6">
                                    {/* Circular Progress 1 */}
                                    <div className="relative w-32 h-32 flex items-center justify-center">
                                        <Doughnut data={totalJoinedData} options={doughnutOptions} />
                                        <div className="absolute text-center pointer-events-none">
                                            <span className="text-xl font-bold text-gray-900 block">7</span>
                                            <span className="text-[10px] text-gray-500 leading-none">Total Joined<br />Webinars</span>
                                        </div>
                                    </div>
                                    {/* Circular Progress 2 */}
                                    <div className="relative w-32 h-32 flex items-center justify-center">
                                        ...
                                        <div className="absolute text-center pointer-events-none">
                                            <span className="text-xl font-bold text-gray-900 block">4</span>
                                            <span className="text-[10px] text-gray-500 leading-none">Missed</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mb-8 px-2">
                                    <div className="w-full bg-blue-100 rounded-full h-4 mb-2">
                                        <div className="bg-blue-300 h-4 rounded-full" style={{ width: '93%' }}></div>
                                    </div>
                                    <p className="text-xs text-center text-gray-500">Your joining rate is reached at <span className="text-gray-900 font-semibold">93%</span></p>
                                </div>
                        ...
                        {/* Chat Box Column */}
                        <div className="bg-white rounded-[20px] p-6 shadow-sm border border-gray-100 flex flex-col h-[600px] lg:h-auto">
                            <h3 className="text-lg font-medium text-gray-600 mb-4 border-b border-gray-100 pb-4">Chat Box</h3>

                            <div className="flex-1 overflow-y-auto space-y-4 pr-2">
                                <div className="flex items-start gap-3">
                                    <div className="w-8 h-8 rounded-full bg-gray-200 overflow-hidden flex-shrink-0">
                                        <Image src="/images/placeholder.png" alt="User" width={32} height={32} className="object-cover" />
                                    </div>
