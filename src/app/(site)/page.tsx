...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="py-[60px] md:py-[80px] px-4 sm:px-6 md:px-12 lg:px-20 xl:px-[108px] min-h-[calc(100vh-80px)] flex items-center justify-center">
        <div className="w-full max-w-[1224px] mx-auto rounded-3xl overflow-hidden shadow-lg bg-white">
          {/* Main Combined Image */}
          ...
          <div className="p-6 md:p-8 lg:p-12 text-center">
            <h2 className="text-[22px] md:text-[32px] lg:text-4xl font-bold text-gray-900 mb-3 md:mb-4">
            ...
            <p className="text-gray-600 text-[14px] md:text-base max-w-full md:max-w-2xl mx-auto mb-6 md:mb-8">
